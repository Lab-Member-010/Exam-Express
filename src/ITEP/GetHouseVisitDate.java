...
public class GetHouseVisitDate extends JFrame {
    private JTextArea dateDisplay;

    public GetHouseVisitDate() {
        setTitle("Get Date");
        setSize(300, 150);
    ...
    private String loadDate() {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("HouseVisitDate.txt"))) {
            String line;
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(GetHouseVisitDate::new);
    }
}
