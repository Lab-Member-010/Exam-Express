...
static int a = 0;
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/loginLOGO.png"))); // NOI18N
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {                                      
         if (t1.getText().trim().isEmpty() || new String(t2.getText()).trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please Enter Your Details");
        } else {
            String username = t1.getText();
            String password = new String(t2.getText());
            String userType = (String) combo.getSelectedItem();

            // Call the backend code to authenticate the user
            Login1 lg = new Login1();
            boolean isAuthenticated = lg.authenticateUser(username, password, userType);
